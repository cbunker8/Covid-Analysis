...
Covid simply performs better in one climate than the other. In this case, the 
...
but as we can see, there death rates are comparable to that of the US and Canada
...
more descriptive than causual.

For instance, a lack of medical supplies and overcrowding definitley were a 
...
The R code used to generate the visualizations in this report is available in the repository. Readers can reproduce the analysis by running the scripts provided.
